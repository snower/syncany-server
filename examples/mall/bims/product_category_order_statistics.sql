...
insert into product_category_order_statistics
...
left join `data/pms_product_category.csv` c on a.product_category_id=c.id
where b.create_time>='${@create_time__gte:1970-01-01 00:00:00}' and b.create_time<'${@create_time__lt:now()}'
group by a.product_category_id order by order_cnt desc limit 50;